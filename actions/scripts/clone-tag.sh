...
git clone --depth=1 --recurse-submodules https://github.com/tianocore/edk2.git -b edk2-stable202208
...
git clone --depth=1 https://github.com/MarvellEmbeddedProcessors/mv-ddr-marvell.git -b mv-ddr-devel